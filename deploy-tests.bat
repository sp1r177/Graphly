...
echo 1. https://graphly-five.vercel.app/api/quick-test
echo 2. https://graphly-five.vercel.app/api/db-test
echo 3. https://graphly-five.vercel.app/api/generate-test
echo.
